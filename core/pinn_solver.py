...
class PINNSolver:
    def __init__(self, model, problem, device="cpu"):
        ...
        self.problem = problem  # Renamed to match your check below
        self.device = device
        ...
        # 2. Pass the combined list to the optimizer
    ...
    def train(self, data, epochs=5000):
        ...
        for epoch in range(epochs):
            ...
            # Call pde_residual from the problem object
            ...
            if epoch % 500 == 0:
                # 4. Print progress + discovered parameters if in Inverse mode
                param_status = ""
